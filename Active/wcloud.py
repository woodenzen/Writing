...
with open('/Users/will/Dropbox/zettelkasten/Writing/Active/Oatmeal/Oatmeal.md','r') as text:
    w.generate(text.read())
    w.to_file("/Users/will/Dropbox/zettelkasten/Writing/Active/Oatmeal/Oatmeal.png")